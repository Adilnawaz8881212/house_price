...
e = st.selectbox('West open', df['west_open'].unique())
f = st.selectbox('Attach bath', df['Attach_bath'].unique())

if st.button("Predict price"):
    # Prepare input data
    user_input = pd.DataFrame([[a,b,c,d,e,f]], columns=['location', 'bedrooms', 'baths', 'size','west_open','Attach_bath'])
